...
final class Version20260223090000 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE online_booking_config (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) NOT NULL DEFAULT 0, booking_mode VARCHAR(20) NOT NULL DEFAULT 'INQUIRY', subsidiaries_mode VARCHAR(20) NOT NULL DEFAULT 'ALL', selected_subsidiary_ids JSON DEFAULT NULL, rooms_mode VARCHAR(20) NOT NULL DEFAULT 'ALL', selected_room_ids JSON DEFAULT NULL, theme_primary_color VARCHAR(7) NOT NULL DEFAULT '#1f6feb', theme_background_color VARCHAR(7) DEFAULT NULL, confirmation_email_template_id INT DEFAULT NULL, inquiry_reservation_status_id INT DEFAULT NULL, booking_reservation_status_id INT DEFAULT NULL, reservation_origin_id INT DEFAULT NULL, payment_terms LONGTEXT DEFAULT NULL, cancellation_terms LONGTEXT DEFAULT NULL, success_message_text LONGTEXT DEFAULT NULL, custom_css LONGTEXT DEFAULT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB");
        $this->addSql("INSERT INTO online_booking_config (enabled, booking_mode, subsidiaries_mode, selected_subsidiary_ids, rooms_mode, selected_room_ids, theme_primary_color, theme_background_color, confirmation_email_template_id, inquiry_reservation_status_id, booking_reservation_status_id, reservation_origin_id, payment_terms, cancellation_terms, success_message_text, custom_css, updated_at) VALUES (0, 'INQUIRY', 'ALL', JSON_ARRAY(), 'ALL', JSON_ARRAY(), '#1f6feb', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NOW())");
