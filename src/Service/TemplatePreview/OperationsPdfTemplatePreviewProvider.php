    ...
    public function getAvailableSnippets(): array
    {
        return [
            [
                ...
                'group' => 'Operations',
                'complexity' => 'easy',
                'content' => "<div class=\"header\"><div style=\"text-align: center; color: #666; font-size: 11px;\">[[ simple.periodLabel ]]<span data-repeat=\"simple.occupancyTypeLabelKeys\" data-repeat-as=\"type\"> | [[ occupancyLabels[type]|trans({}, 'Housekeeping') ]]</span> | [[ simple.subsidiaryLabel ]] | Erzeugt [[ simple.generatedAt ]]</div></div><div class=\"footer\"><div style=\"text-align: right; font-size: 11px; color: #666;\">Seite {PAGENO} von {nbpg}</div></div>",
            ],
            [
