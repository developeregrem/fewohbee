...
class CalendarEntryType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            // On a range this lands on the last day, not on every day - see
            // CalendarEntry::$endTime and the loop in
            // ReservationServiceController::newCalendarEntryAction().
            ->add('endTime', TimeType::class, [
                'label' => 'calendar_entry.form.end_time',
                'widget' => 'single_text',
                'input' => 'datetime_immutable',
                'required' => false,
                'help' => 'calendar_entry.form.end_time_help',
            ]);
