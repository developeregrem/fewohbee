...
return [
    ...
    '@tiptap/extension-text-align' => ['version' => '3.30.2'],
    '@tiptap/extension-table' => ['version' => '3.30.2'],
    '@tiptap/extension-underline' => ['version' => '3.30.2'],
    '@tiptap/extension-text-style' => ['version' => '3.30.2'],
    '@tiptap/extension-dropcursor' => ['version' => '3.30.2'],
    '@tiptap/extension-gapcursor' => ['version' => '3.30.2'],
    ...
    '@tiptap/extension-table-row' => ['version' => '3.30.2'],
    '@tiptap/extension-table-cell' => ['version' => '3.30.2'],
    '@tiptap/extension-table-header' => ['version' => '3.30.2'],
    'codemirror' => ['version' => '6.0.2'],
    '@codemirror/lang-html' => ['version' => '6.4.12'],
    '@codemirror/autocomplete' => ['version' => '6.20.3'],
    '@codemirror/view' => ['version' => '6.43.9'],
    '@codemirror/state' => ['version' => '6.7.1'],
    '@codemirror/language' => ['version' => '6.12.4'],
    '@codemirror/commands' => ['version' => '6.11.0'],
